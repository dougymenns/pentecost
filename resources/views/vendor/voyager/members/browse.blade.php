...
@section('page_header')
	...
	<!-- Button trigger modal -->
		...
		{{--button trigger for  export--}}
		<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exportModal">
			<a href="{{route('ex')}}" style="text-decoration: none; color:white;">Bulk Export</a>
		</button>
...
@section('content')
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p style="color:red;">This will not work if your excel file has member records that already exist in this table</p>
					<p>Choose the excel file that you want to import</p>
	...
	{{--<div class="modal" id="exportModal" tabindex="-1" role="dialog">--}}
		{{--<div class="modal-dialog" role="document">--}}
			{{--<div class="modal-content">--}}
				{{--<div class="modal-header">--}}
					{{--<h5 class="modal-title">Bulk Export</h5>--}}
					{{--<button type="button" class="close" data-dismiss="modal" aria-label="Close">--}}
						{{--<span aria-hidden="true">&times;</span>--}}
					{{--</button>--}}
				{{--</div>--}}
				{{--<div class="modal-body">--}}
					{{--<p>Choose the excel file that you want to export</p>--}}
